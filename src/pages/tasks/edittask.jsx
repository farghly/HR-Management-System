...
import { createTask, getTaskById } from "../../api/tasksAPI";
...
function EditTask() {
  ...
  useEffect(() => {
    getTaskById(taskId).then((res) => {
      setCurrentTask(res.data.data.data);
    });
  }, []);
      ...
      >
        <div className="data d-flex flex-column gap-2">
          ...
          <input
            ...
            placeholder={defaultFormData.name}
          />
          <ErrorMessage
            errors={errors}
            name="name"
        ...
        <div className="data d-flex flex-column gap-2">
          ...
          <textarea
            ...
            value={description}
            onChange={changeHandler}
            placeholder={defaultFormData.description}
          ></textarea>
          <ErrorMessage
            errors={errors}
            name="description"
        ...
        <div className="data d-flex flex-column gap-2">
          ...
          <textarea
            ...
            value={summary}
            onChange={changeHandler}
            placeholder={defaultFormData.summary}
          ></textarea>
          <ErrorMessage
            errors={errors}
            name="summary"
